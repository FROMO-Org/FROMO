...
all_routers = [events_router, organisations_router, profiles_router, saved_events_router, bookings_router, payments_router, venues_router, busyness_router, dashboard_router]
